...
{
	private const string TestMessage = "Test null argument error message";
	...
	private const string ExpectedCode = "ARG_NULL";
	...
	{
		// Arrange & Act
		var exception = new ArgNullException(TestMessage);
	...
	public void Constructor_WithMessageAndInnerException()
	{
		...
		// Act
		var exception = new ArgNullException(TestMessage, innerException);
	...
	public void Constructor_WithInnerExceptionOnly()
	{
		...
		// Act
		var exception = new ArgNullException(innerException);
	...
	public void ToString_WithComplexExceptionChain_IncludesAllExceptions()
	{
		...
		var level1Exception = new ArgNullException(TestMessage, level2Exception);
	...
	{
		// Arrange
		ArgNullException exception;
		try
		{
			throw new ArgNullException(TestMessage);
		}
		catch (ArgNullException ex)
		{
			exception = ex;
		}
		...
		// Assert
		Assert.That(toStringResult, Does.Contain("--ArgNullException"));
	...
	public void Inheritance_FromDetailedException_WorksCorrectly()
	{
		...
		Assert.That(exception, Is.InstanceOf<ArgNullException>());
	}

	[Test]
	public void Code_IsAlwaysSetToArgNull()
	{
		// Arrange & Act
		var exception1 = new ArgNullException(TestMessage);
		var exception2 = new ArgNullException();
		var exception3 = new ArgNullException(new Exception());
